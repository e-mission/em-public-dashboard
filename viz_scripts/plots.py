...
def proportion_hist_plot(data,x_col,plot_title,ylab,file_name):
    fig, ax = plt.subplots(figsize=(8,6))
    sns.histplot(ax=ax, data=data, x=x_col, hue='Mode', element='poly', multiple='stack').set(title=plot_title, ylabel=ylab, xlabel='Trip Distance (mi)')
    plt.subplots_adjust(bottom=0.25)
    ax.figure.savefig(SAVE_DIR+file_name+".png", bbox_inches='tight')
